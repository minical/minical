	...
	<div class="panel panel-default hidden-print">
		<div class="panel-body h4">
			<div class="form-inline">
                ...
                <a style="margin: 0 10px;" href="<?php if($url_date != '//'){ echo base_url()."reports/download_taxes_csv_export/".$url_date; } else { echo base_url()."reports/download_taxes_csv_export/"; } ?>" class="btn btn-primary pull-right ">
