<div class="settings integrations">
    ...
    <div class="panel panel-default ">
        ...
        <div class="panel-body form-horizontal ">
            ...
            <h4>
			<?php echo l('Edit Marketing Segment'); ?>
		</h4>
                ...
                <div class="form-group rate-group ">
                    ...
                    <div class="col-sm-6">
					 <label for="debtor_name" class="control-label">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo isset($segment['post_title']) ? $segment['post_title'] : ''; ?>">
                    </div>
					 <div class="col-sm-6">
					<label for="debtor_description" class="control-label">
                        <span alt="debtor_description" title="debtor_description">Description</span>
                    </label>
                        <input type="text" name="description" class="form-control" value="<?php echo isset($segment['post_content']) ? $segment['post_content'] : ''; ?>">
                    </div>
                </div>
...
<input type="hidden" name="segment_id" class="form-control" value="<?php echo isset($segment['post_id']) ? $segment['post_id'] : ''; ?>">
