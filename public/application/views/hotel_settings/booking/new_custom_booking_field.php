<tr class="booking-field-tr" id="<?php echo $id; ?>">
	<td>
	...
	<td class="text-center">
		<div class="checkbox">
				<label>
	  			<input type="checkbox" name="show_on_booking_form" autocomplete="off" checked="checked"/>
			</label>
		</div>
	</td>
	<td class="text-center">
	...
	<td class="text-center">
		<div class="delete-booking-field btn btn-light" id="<?php echo $id; ?>">X</div>
	</td>
</tr>