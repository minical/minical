...
switch ($_SERVER['HTTP_HOST']) {
	case 'localhost': // local
		...
		$config['base_url']	= "http://localhost/minical/public"; // localhost
		$config['cm_url']	= "http://localhost/innGrid_cm/cm"; // production
		break;
...
|
*/
$config['encryption_key'] = '1nnGr1d3ncryption';
...
|
http://codeigniter.com/forums/viewthread/102456/#523991
*/
...
$config['sess_time_to_update']	= 79200;
...
$config['current_translation_version']	= '2';
...
$config['quickbooks_gateway_client_id']	= isset($_SERVER["QUICKBOOK_CLIENT_ID"]) ? $_SERVER["QUICKBOOK_CLIENT_ID"] : "";
$config['quickbooks_gateway_client_secret']	= isset($_SERVER["QUICKBOOK_CLIENT_SECRET"]) ? $_SERVER["QUICKBOOK_CLIENT_SECRET"] : "";
