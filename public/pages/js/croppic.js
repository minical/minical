	...
	Croppic.prototype = {
				...
				if(that.options.processInline){
					...
					$.ajax({
						...
						if(response.status=='success'){
							...
							var versionedImgUrl = response.url + '?v=' + version;
							var img = $('<img src="'+versionedImgUrl+'">')
		...
		crop:function(){
			...
			var cropData = {
					...
					imageGroupID: that.options.imageGroupID // 2015-01-06 Jaeyun. To pass the image_type variable
				};
