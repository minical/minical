...
(function($) {
    ...
    CustomerModal.prototype = {
        ...
        _getHorizontalInput: function(label, name, value, element_class = '', is_required = false) {
            ...
            var availableCountries = [{"name": "Afghanistan", "code": "AF"}, 
            ...
            var MycountryArray = [];
            var MycountrycodeArray = [];

             availableCountries.forEach(function availableCountry(item, index){
                 allcountry += item.name+",";
                  MycountryArray = allcountry.split(',');

                  allcountrycode += item.code+",";
                  MycountrycodeArray = allcountrycode.split(',');
               
            });

            console.log(typeof allcountry);
            console.log( MycountryArray);
            console.log(MycountrycodeArray);
                        ...
                        $("<div/>", {
                            ...
                            $("<input/>", {
                                ...
                                'data-label': label
                                    ...
                                    source:  MycountrycodeArray.concat(MycountryArray)
                            }) 
                        )
