  ...
  * ============================== */
  ...
  , createToken: function (attrs, triggerChange) {
      ...
      if (typeof attrs.value === 'undefined') // 
        attrs.value = $.trim(attrs.customer_name.toString()); // for innGrid. Jaeyun 2015-03-20
      else
      ...
      // Added for innGrid by Jaeyun 2015-03-20
      if (typeof attrs.id === 'undefined')
        var customer_id = attrs.customer_id;
      else
        var customer_id = attrs.id;
      ...
      switch(e.keyCode) {
        ...
        case 13: // enter
          ...
          if (this.$input.is(document.activeElement) && this.$input.val().length || this.$input.data('edit')) {
            $(".ui-autocomplete").hide(); // Jaeyun 2015-05-25. Hide autocomplete after token is created
