...
//http://lopezb.com/hoteldatepicker/
...
HotelDatepicker.prototype.reinit = function reinit (newDisabledDates, currentMonth) {
...
HotelDatepicker.prototype.resetDisabledDates = function resetDisabledDates (newDisabledDates) {
	this.disabledDates = newDisabledDates;
	if (this.disabledDates.length > 0) {
		this.parseDisabledDates();
	}
...
HotelDatepicker.prototype.reRenderCalendar = function reRenderCalendar (evt) {
	var thisMonth = $(evt.target).attr('month');
	console.log('thisMonth', thisMonth);
	if(thisMonth == undefined)
	{
		this.showMonth(this.month1, 1);
		this.showMonth(this.month2, 2);
	}
	else{
		var isMonth2 = thisMonth > 1;
		...
		this.showMonth((thisMonth == 1 ? this.month1 : this.month2), thisMonth);
	}
